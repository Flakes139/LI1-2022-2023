...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g112.git
$ cd 2022li1g112
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g112.git
$ cd 2022li1g112
```
...
- **A104527** Vasco João Timóteo Gonçalves;
